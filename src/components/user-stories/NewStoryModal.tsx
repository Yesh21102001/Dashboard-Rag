...
export default function NewStoryModal({ open, onClose, onCreate, selectedFolder }: NewStoryModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden p-5 box-border">
      ...
      >
        <div className="sticky top-0 z-10 flex items-center justify-between gap-3 border-b border-outline-variant bg-surface-container-lowest px-5 py-4">
          <h2 className="font-title-sm text-title-sm text-on-surface">Create New User Story</h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="grid grid-cols-1 gap-4 p-5 md:grid-cols-2">
          ...
          <div className="md:col-span-2 mt-3 flex justify-end gap-2 border-t border-outline-variant pt-4">
            <button type="button" onClick={onClose} className="rounded-md border border-outline-variant px-4 py-2 text-body-sm text-on-surface hover:bg-surface-variant">
              Cancel
            </button>
            <button type="submit" className="rounded-md bg-primary px-4 py-2 text-body-sm font-medium text-on-primary hover:bg-primary/90">
              Create
            </button>
          </div>
        </div>
